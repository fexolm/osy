...
OBJ = gdt.o gdt_asm.o idt.o idt_asm.o interrupt.o interrupt_asm.o io.o kmain.o loader.o pic.o tss.o tss_asm.o keyboard.o fb.o serial.o pfa.o memory.o buffer.o
